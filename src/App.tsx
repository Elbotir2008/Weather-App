...
const App = () => {
  ...
  const API_KEY = "mlt5ODLM9iw7T08AGBDGu34pOccarvU1";
  const exclude = "daily";
  const API_URL = `https://api.tomorrow.io/v4/weather/forecast?exclude=${exclude}&apikey=${API_KEY}&location=`;
    ...
    <div className="App">
      ...
      {forecast && (
        <div className="cardContainer">
          <div className="card">
            <p className="city">{forecast.location.name}</p>
            <p className="weather">{forecast.timelines.daily[0].time}</p>
            <svg
              className="weather"
              version="1.1"
              id="Layer_1"
            ...
            <p className="temp">{Math.floor(forecast.timelines.daily[0].values.temperatureApparentAvg)}°</p>
            <div className="minmaxContainer">
              <div className="min">
                <p className="minHeading">Min</p>
                <p className="minTemp">{forecast.timelines.daily[0].values.temperatureMax}°</p>
              </div>
              <div className="max">
                <p className="maxHeading">Max</p>
                <p className="maxTemp">{forecast.timelines.daily[0].values.temperatureMin}°</p>
              </div>
            </div>
          </div>
        </div>
